...
namespace Tp3_ift1179
{
    ...
    class VolCharter :Vol
    {
        ...
        private bool wifi;
        public VolCharter(string categorie, string num, string dest, Date date, string nbTotalR,string typeAvion) : base(categorie, num, dest, date, nbTotalR, typeAvion)
        {
