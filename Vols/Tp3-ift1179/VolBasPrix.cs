...
namespace Tp3_ift1179
{
    ...
    class VolBasPrix : Vol
    {
        ...
        private bool wifi;
        public VolBasPrix (string categorie, string num, string dest, Date date, string nbTotalR, string typeAvion) : base(categorie, num, dest, date, nbTotalR, typeAvion)
        {
